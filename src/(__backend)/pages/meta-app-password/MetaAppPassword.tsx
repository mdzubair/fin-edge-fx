...
return (
  ...
  // return (
  //   <div className="container-fluid">
  //     <div className={`row g-4 mb-4 ${userId.trim()=="" ? "justify-content-center" : ""}`}>
  //       {/* Credentials Card */}
  //       <div className="col-lg-6" style={{ display: !userId ? "none" : "block" }}>
  //         <div className="card shadow-sm h-100">
  //           <div className="card-header">
  //             <h5 className="mb-0">App Credentials</h5>
  //           </div>
  ...
  //         <div className="card shadow-sm">
  //           <div className="card-header">
  //             <h5 className="mb-0">Video Tutorial 1</h5>
  //           </div>

  //           <div className="card-body">
  //             <div className="ratio ratio-16x9">
  //               <iframe
  //                 src="../../../default/android.mp4"
  //                 title="Tutorial 1"
  //                 allowFullScreen
  //               />
  //             </div>
  ...
  //         <div className="card shadow-sm">
  //           <div className="card-header">
  //             <h5 className="mb-0">Video Tutorial 2</h5>
  //           </div>

  //           <div className="card-body">
  //             <div className="ratio ratio-16x9">
  //               <iframe
  //                 src="../../../default/trade-us.mp4"
  //                 title="Tutorial 2"
  //                 allowFullScreen
  //               />
  //             </div>
