...
const UsdDepositForm = () => {
  ...
  return (
    <>
            ...
            <div className="row g-4">
                {tabs.map((tab) => ( 
                    <div className="col-lg-6 col-md-6" key={tab.id}>
                        <div className={`card h-100 shadow-sm position-relative transition-all ${ activeTab === tab.id ? "border-primary border-3" : "border-light" }`} style={{ cursor: "pointer", transition: "0.3s ease", borderRadius: "15px", }} onClick={() => setActiveTab(tab.id)}>
                            {activeTab === tab.id && (
                                <span
      ...
      {/* BEP20 */}
      {(activeTab === "bep20" || activeTab === "erc20" ||activeTab === "polygon" || activeTab === "trc20") && (
        ...
        <div className="card-body">
          ...
          <div className="bg-light rounded-3 p-3 text-center mb-4">
            ...
            <h6 className="fw-bold mb-0 mt-1">
              1 USDT ({activeTab.toUpperCase()}) = 1 USDT
            </h6>
          ...
          <div className="alert alert-warning border-0 rounded-3 mb-4 p-2">
            ...
            <div className="d-flex">
              ...
              <small> Please note that USDT can only be received via the{" "} <strong>{activeTab.toUpperCase()}</strong> protocol. Deposits made through any other network cannot be received or recovered. </small>
